...
class Task12Test {
    ...
    @Test
    @DisplayName("Find animals that bites and has height > 100")
    void findAmountOfAnimalsWithWeightGreaterThanHeight() {
        // given
        var animals = getListOfAnimals();

        // when
        var result = AnimalUtilities.getAmountOfAnimalsWithWeightGreaterThanHeight(animals);
